      ...
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mb-8 md:mb-0 md:w-1/3">
          ...
          <p className="mt-2 text-sm text-gray-400">
            An open-source platform for experimenting with and comparing different RAG architectures.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-8 md:w-2/3 md:grid-cols-3">
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li>
                <Link href="/docs" className="text-gray-400 hover:text-blue-400 transition">
                  Documentation
                </Link>
              </li>
              <li>
                <a href="https://github.com/dchaudhari7177/Cognitive" 
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              <li>
                <a href="https://github.com/dchaudhari7177/Cognitive/issues" 
                   className="text-gray-400 hover:text-blue-400 transition"
                   target="_blank"
                   rel="noopener noreferrer"
                >
              ...
              <li>
                <a href="https://dipakchaudhari.com" 
                   className="text-gray-400 hover:text-blue-400 transition"
                   target="_blank"
                   rel="noopener noreferrer"
                >
      ...
      <div className="border-t border-gray-800 px-6 py-6">
        <div className="mx-auto max-w-7xl flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-gray-500">
            © {new Date().getFullYear()} RAG Playground. All rights reserved.
          </p>
          <div className="flex items-center space-x-6 mt-4 md:mt-0">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-blue-400 transition flex items-center space-x-2"
            >
              <span className="text-xs">Built by</span>
              <span className="text-sm font-medium">Dipak Chaudhari</span>
            </a>
            <div className="flex items-center space-x-4">
              <a
                href="https://github.com/dchaudhari7177"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:text-blue-400 transition"
              >
